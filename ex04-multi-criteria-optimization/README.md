[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/GZWnNeqK)
# Multicriteria Optimization

## Assignment Instructions / TODOs

In the lecture, you learned the fundamentals of multi-criteria optimization. Since you have already implemented Evolutionary Algorithms (EAs) and
Bayesian Optimization (BO), your task is to implement several small methods necessary to extend these implementations for multi-objective optimization.

Please refer to the [PDF](https://drive.google.com/file/d/1gyh989CnxDnNQuvv4xz_l2CkCykJpw6E/view?usp=sharing) for full assignment instructions.
...
#### Deadline
The assignment is due on **CEST 23:59 of May 29, 2026.**

Incase of any further issues, please reach out to us via discord classroom forum using the tag "Multicriteria".
