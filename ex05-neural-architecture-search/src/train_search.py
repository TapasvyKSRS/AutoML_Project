...
class Architect(object):
    ...
    def step(self, input_valid, target_valid):
        ...
        #      and compute the validation loss
...
def main(args):
    ...
    model = Network(device, nodes=2, one_shot_optimizer=args.one_shot_optimizer).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save', type=str, default='outputs/logs_search', help='path to logs')
    parser.add_argument('--seed', type=int, default=2, help='random seed')
    parser.add_argument('--one_shot_optimizer', type=str, default='darts', help='optimizer to use for one-shot search')
    args = parser.parse_args()

    # logging utilities
    args.save = '{}/{}'.format(args.save, args.one_shot_optimizer)
